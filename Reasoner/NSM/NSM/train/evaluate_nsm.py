...
def f1_and_hits_new(answers, candidate2prob, eps=0.5):
    ...
    if len(answers) == 0:
        ...
        if len(retrieved) == 0:
            ...
            return p, r, f1, hits, 3, retrieved, best_ans
    ...
    def evaluate(self, valid_data, test_batch_size=20, write_info=False):
        ...
        for iteration in range(num_epoch):
            ...
            for batch_id in range(batch_size):
                ...
                precision, recall, f1, hit, case, retrived, best_ans = f1_and_hits_new(answers, candidate2prob, eps)
                if write_info:
        ...
        if write_info:
            ...
            self.file_write = None
        return np.mean(f1s), np.mean(hits), best_ans