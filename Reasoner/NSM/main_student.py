...
parser.add_argument('--teacher_type', default='label_fb', type=str)
parser.add_argument('--teacher_model', default='gnn', type=str)
    ...
    if not args.is_eval:
        ...
        for conv in tqdm(all_test_data):
            ...
            for idx,q in enumerate(conv['questions']):
                ...
                cover = retrieve_single_subgraph(single_data, entity2id, relation2id, path_dict, sparql_retriever, file_path)
                total_cover += cover
